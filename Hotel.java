...
public class Hotel {
	...
	public Hotel (String RMNO, String RMDESC, String RMTYPE, String PRICE, String BOOKST) {
		this.RMNO = RMNO;
		this.RMDESC = RMDESC;
		this.RMTYPE = RMTYPE;
		this.PRICE = PRICE;
	...
	public void saveToFile() {
		try(BufferedWriter writer = new BufferedWriter(new FileWriter("Hotel.txt", true))) {
	...
	public static List<Hotel> getFromFile() throws IOException{
		...
		try (BufferedReader reader = new BufferedReader(new FileReader("Hotel.txt"))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                h.add(new Hotel(RMNO,RMDESC,RMTYPE,PRICE,BOOKST));
            }
		}
            return h;
	}
	...
	public static void add() {
		...
		Hotel h = new Hotel(RMNO,RMDESC,RMTYPE,PRICE,BOOKST);
		h.saveToFile();
	}
	public static void display() throws IOException {
		List <Hotel> hotel = (List<Hotel>) Hotel.getFromFile();
